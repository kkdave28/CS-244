...
main(int argc, char *argv[])
{
   ...
   ****************************************************************************/
   ...
   // Adding loop here for processing multiple images as specified by the user in the command line args
   for(int count = 0; count< num_images; count++)
   {
      ...
      ****************************************************************************/
      sprintf(outfilename, "camera_s_%3.2f_l_%3.2f_h_%3.2f_frame_%i.pgm", sigma, tlow, thigh,count);
